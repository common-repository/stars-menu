<?php
/**
 * Stars Menu Link After Template
 *
 * This template can be overridden by copying it to yourtheme/stmenu/modern-horizontal/link_after.php.
 *
...
if ( $has_children && ( empty( $item->url ) || trim( $item->url ) == "#" || $is_disable_link ) && !$back_item_mode ) {
	?>
	<!-- </span> --><div class="starsmenu-item-arrow"><i class="<?php echo esc_attr( $arrow );?>"></i></div>
	<?php
}
