...
//edit by parsaatef
require_once( TF_PATH . 'lib/class-option-gradient.php' );
require_once( TF_PATH . 'lib/class-option-icon.php' );
require_once( TF_PATH . 'lib/class-option-menu-design.php' );
require_once( TF_PATH . 'lib/class-option-menu-integrate.php' );
require_once( TF_PATH . 'lib/class-option-menu-instances.php' );
require_once( TF_PATH . 'lib/class-option-multi-text.php' );
require_once( TF_PATH . 'lib/class-option-box-shadow.php' );
require_once( TF_PATH . 'lib/class-option-menu-mobile-design.php' );
require_once( TF_PATH . 'lib/class-option-custom-widget-areas.php' );
