...
class TitanFrameworkOptionCode extends TitanFrameworkOption {
	...
	public function display() {
		...
		$textarea = sprintf( "<textarea name='%s' id='%s' style='display: none'>%s</textarea>",
			esc_attr( $this->getID() ),
			esc_attr( $this->getID() ),
		...
		//edit by parsaatef
		printf( '<div data-height="%1$s" data-theme="%2$s" data-lang="%3$s" class="stars_ace_editor ace_editor_wrapper" data-editor-id="%4$s_ace_editor" ><div id="%4$s_ace_editor"></div>%5$s</div>',
