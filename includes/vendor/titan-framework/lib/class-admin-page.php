...
class TitanFrameworkAdminPage {
	...
	private function verifySecurity() {
		...
		//edit by parsaatef
		if ( !is_null( $screen ) && is_object( $screen ) && $screen->id != $this->panelID ) {
			return false;
		}
	...
	public function createAdminPage() {
		...
		//Edit By Parsaatef
		do_action( 'tf_admin_page_before_table' , $this , 'admin_page' );
		do_action( 'tf_admin_page_before_table_' . $this->getOptionNamespace() , $this , 'admin_page' );
		...
		//Edit By Parsaatef
		do_action( 'tf_admin_page_after_table' , $this , 'admin_page' );
		do_action( 'tf_admin_page_after_table_' . $this->getOptionNamespace() , $this , 'admin_page' );
