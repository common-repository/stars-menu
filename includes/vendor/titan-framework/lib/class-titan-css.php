...
class TitanFrameworkCSS {
	...
	//edit by parsaatef convert private to public
	/**
	...
	public function generateCSS() {
		...
		//edit by parsaatef
		$this->allOptionsWithIDs = apply_filters( "stars_menu_all_options_with_css" , $this->allOptionsWithIDs );
	...
	public function generateSaveCSS() {
		...
		//edit By parsaatef
		$cssString = apply_filters( "tf_stars_menu_generate_css" , $cssString );
